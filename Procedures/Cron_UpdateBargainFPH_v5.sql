...
BEGIN
  ...
  IF iHistNo > 0 THEN
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,106,131,1,106); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,6918,132,1,6918); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,295,133,1,295); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,8648,134,1,8648); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,83,135,1,83); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,97,136,1,97); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,91,137,1,91); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,163,138,1,163); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,5,139,1,5); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,7153,140,1,7153); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,3591,141,1,3591); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,2980,142,1,2980); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,157,143,1,157); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,179,144,1,179); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,2957,145,1,2957); --US
    ...
    Cron_fe_updateBargainFPH_v5.updateBargainFPH(234626,1,10961,146,1,10961); --US
