CREATE OR REPLACE package Pkg_BO_SubscriptionDALC
AS
...
CREATE OR REPLACE package body Pkg_BO_SubscriptionDALC
is
  PROCEDURE GetSubscriptionProduct (
    iPsubscriptionSku IN INT,
    iPsiteId IN INT,
...
and ya_product_subscription.sku=productRegion.productid and categoryId=1 and productRegion.originid=iPsiteId and  productRegion.cansell='Y' and  productRegion.enable='Y' and subscription_sku=iPsubscriptionSku
