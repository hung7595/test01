...
and ya_product_subscription.sku=pr.productid and pr.categoryId=1 and pr.originid=iPsiteId and  pr.cansell='Y' and  pr.enable='Y' and subscription_sku=iPsubscriptionSku
