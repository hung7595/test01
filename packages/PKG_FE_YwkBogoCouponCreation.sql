...
AS
  ...
  BEGIN
    ...
    INSERT INTO ya_coupon VALUES (iPcouponCode, iPcampaignName, iPcouponDescription, iPcouponAmount, null, 0, null, null, null, iPexpiredDate, iPshopperId, 'N', 'N', 1, 99, sys_guid(), 'Backend BOGO promotion coupon', sysdate, ipcouponcurrency, null, null);
