...
REM START SS_ADM PKG_BO_AWARDDALC

  CREATE OR REPLACE PACKAGE "SS_ADM"."PKG_BO_AWARDDALC" 
AS
...
/
CREATE OR REPLACE PACKAGE BODY "SS_ADM"."PKG_BO_AWARDDALC" 
AS
  PROCEDURE GetMultiEventsByIds (
    curPresult OUT refCur,
    iPevent_id_1 IN INT DEFAULT NULL,
...
REM END SS_ADM PKG_BO_AWARDDALC
