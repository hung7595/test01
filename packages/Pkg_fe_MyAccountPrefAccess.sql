...
IS
  ...
  BEGIN
    ...
    INSERT INTO YA_ASSOCIATE_LINK (
      associate_id,link_id,site_name,LINK_CODE,LINK_TYPE,LINK_PERCENTAGE,LINK_STATUS,LINK_URL,LINK_DESC,CREATED_DATE,LANG_ID)
    VALUES (iPassociateId, iLlinkId, cPsiteName, cLlinkCode , 2, 0.1, 2, 'http:', cPsiteName, sysdate, 1 );
