...
IS
  ...
  BEGIN
    ...
    INSERT INTO ya_address (address_id, lang_id, shopper_id, address_profile_name, firstname,
      lastname, address1, address2, city, state, state_id, zip, country_id, day_phone, fax_number, email, site_id, rowguid)
    VALUES
      (iLaddress_current, 1, cPshopper_id, cPprofile_name, cPfirstname, cPlastname, cPaddress1,
      cPaddress2, cPcity, cPstate, iPstate_id, cPzip, iPcountry_id, cPphone, cPfax, cPemail, iPsite_id, sys_guid());
  ...
  BEGIN
    UPDATE ya_address SET address_profile_name = cPprofile_name, firstname = cPfirstname,
      ...
      city = cPcity, state = cPstate, state_id = iPstate_id, zip = cPzip, country_id = iPcountry_id,
      day_phone = cPphone, fax_number = cPfax, email = cPemail
