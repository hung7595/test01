DROP TABLE Ya_Browse_Dept_Table
/

CREATE TABLE Ya_Browse_Dept_Table (
...
ALTER TABLE Ya_Browse_Dept_Table
ADD CONSTRAINT PK_Browse_Dept_Table PRIMARY KEY (lang_id, parent_dept_id, dept_id)
USING INDEX TABLESPACE SSCommerceserver_Index
/


CREATE PUBLIC SYNONYM Ya_Browse_Dept_Table FOR Ya_Browse_Dept_Table
/


create or replace TRIGGER TRI_browse_dept_table_1
BEFORE INSERT OR UPDATE OF us_enabled
ON ya_browse_dept_table
FOR EACH ROW
BEGIN
	:NEW.us_enabled := UPPER(:NEW.us_enabled);
END;

create or replace TRIGGER TRI_browse_dept_table_2
...
create or replace TRIGGER TRI_browse_dept_table_3
...
create or replace TRIGGER TRI_browse_dept_table_4
...
create or replace TRIGGER TRI_browse_dept_table_5
...
create or replace TRIGGER TRI_browse_dept_table_6
...
create or replace TRIGGER TRI_browse_dept_table_7
...
create or replace TRIGGER TRI_browse_dept_table_8
